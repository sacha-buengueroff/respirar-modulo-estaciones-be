...
import { StationRouter } from "./router/stations.js";
import { ApplicationRouter } from "./router/applications.js";
...
class Server {
    ...
    async start() {
        ...
        /*                             ROUTING                             */
        /* --------------------------------------------------------------- */
        this.app.use("/estaciones", new StationRouter().start());
        this.app.use("/solicitudes", new ApplicationRouter().start());
        /* --------------------------------------------------------------- */
        /*                         SERVER LISTEN                           */
        /* --------------------------------------------------------------- */
